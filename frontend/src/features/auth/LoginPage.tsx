...
export function LoginPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const fallback = user.role === 'admin' ? '/admin' : user.role === 'reviewer' ? '/reviewer' : user.role === 'requester' ? '/requester' : '/student'
